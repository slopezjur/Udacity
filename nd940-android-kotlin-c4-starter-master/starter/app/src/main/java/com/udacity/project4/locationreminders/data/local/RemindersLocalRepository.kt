        ...
        wrapEspressoIdlingResource {
            return withContext(ioDispatcher) {
                return@withContext try {
                    ResultState.Success(remindersDao.getReminders())
                } catch (ex: Exception) {
                    ResultState.Error(Exception(ex.localizedMessage))
                }
            }
        }
    }
        ...
        wrapEspressoIdlingResource {
            return withContext(ioDispatcher) {
                try {
                    ...
                    if (reminder != null) {
                        return@withContext ResultState.Success(reminder)
                    } else {
                        return@withContext ResultState.Error(Exception("Reminder not found!"))
                    }
                } catch (e: Exception) {
                    return@withContext ResultState.Error(Exception(e.localizedMessage))
                }
            }
        }
    }
